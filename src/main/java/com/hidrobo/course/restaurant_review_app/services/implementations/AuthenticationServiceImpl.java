...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private final Long jwtExpiryMin = 86400000L;
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + jwtExpiryMin))
    ...
    private String extractUsername(String token) {
        Claims claims = Jwts.parserBuilder().setSigningKey(getSignedKey()).build()
